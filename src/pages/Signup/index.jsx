...
const Signup = () => {
    ...
    return (
        <div className='flex justify-center items-center  bg-gray-200'>
            <div className='w-[400px] shadow-md  my-6 p-4 rounded-md bg-white'>

                <h1 className='text-[20px] font-bold'>Sign Up</h1>
                <form>
                    <div className='grid grid-cols-1 mb-5 mt-5'>
                        <div className='col'>
                            <h3 className='text-[14px] font-[500] mb-1'>Name</h3>
                    ...
                    <div className='grid grid-cols-1 mb-5 mt-5'>
                        <div className='col'>
                            <h3 className='text-[14px] font-[500] mb-1'>Phone No</h3>
                            <input type='text' className='w-full h-[40px] border border-[rgba(0,0,0,0.3)] focus:outline-none focus:border-[rgba(0,0,0,0.5)] rounded-sm p-3 text-sm' />
                        </div>
                    </div>
                    <div className='grid grid-cols-1 mb-5 mt-5'>
